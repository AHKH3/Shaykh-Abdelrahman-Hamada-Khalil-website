                    ...
                    {!isRangeMode && juz !== undefined && pageNumber !== undefined && (
                        <div className="flex items-center justify-between mb-8 pb-4 border-b border-border/40 opacity-60 hover:opacity-100 transition-opacity duration-500">
                            <div className="mushaf-engraved-container px-3 py-1 flex items-center gap-3">
                                <span className="mushaf-text-overline font-bold uppercase tracking-widest text-primary/80 drop-shadow-sm">
                                    {juzLabel} {juz}
                                </span>
                                <span className="mushaf-text-overline flex items-center justify-center w-6 h-6 rounded-full bg-primary/10 text-primary font-bold shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)]">
                                    {pageNumber}
                                </span>
                            </div>
                        </div>
                    ...
                    {isRangeMode && chapterName && (
                        <div className="text-center mb-10 relative">
                            ...
                            <div className="inline-block relative z-10 px-10 py-4 bg-background/80 backdrop-blur-md rounded-2xl border border-primary/20 shadow-lg shadow-primary/5 ring-1 ring-white/5">
                                ...
                                <h2 className="relative text-2xl font-bold font-['Amiri',serif] text-primary drop-shadow-[0_2px_4px_rgba(var(--color-primary-rgb),0.2)] whitespace-nowrap">
                                    {chapterName}
                                </h2>
                            ...
                            {(fromVerse === 1 && chapterId !== 1 && chapterId !== 9) && (
                                <div className="mt-8 relative group cursor-default">
                                    ...
                                    <p className={`relative font-['Amiri',serif] text-primary/90 drop-shadow-[0_1px_2px_rgba(var(--color-primary-rgb),0.1)] ${fontSizeClass} transition-all duration-500`}>
