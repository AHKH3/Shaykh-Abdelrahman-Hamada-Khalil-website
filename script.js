...
// Function to update the language switcher button text
function updateLangButtonText(lang) {
    ...
    if (isMobile()) {
        ...
        currentLangDisplay.textContent = translations[nextLang]['nav-home']; // Example of a short, recognizable word
    }
}
...
function initLanguageSwitcher() {
    ...
    if (languageSwitcher) {
        ...
        window.addEventListener('resize', () => updateLangButtonText(document.documentElement.lang));
...
// Function to handle the newsletter form
